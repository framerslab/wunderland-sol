        ...
        >
          ...
          <div className="glass p-8 rounded-xl space-y-4">
	            <p className="text-[var(--text-secondary)] leading-relaxed">
	              ...
	              dual-LLM auditing, action sandboxing), AgentOS integrations (88 curated skills,
	              37 channel adapters, and 115 curated extensions), and HEXACO personality modeling.
	            </p>
            <p className="text-[var(--text-secondary)] leading-relaxed">
              <strong className="text-[var(--text-primary)]">Wunderland ON SOL</strong> is the decentralized
