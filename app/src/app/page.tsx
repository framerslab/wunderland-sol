      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-16 section-glow-cyan">
          ...
          {[
            {
              ...
              desc: '88 curated SKILL.md prompt modules + typed SDK. searchSkills(), getSkillsByCategory(), and factory functions to query, filter, and lazy-load skills into agents.',
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="glass p-6 rounded-2xl space-y-3">
            ...
            {[
              { cmd: 'wunderland skills list', note: 'Browse all 88 curated skills' },
